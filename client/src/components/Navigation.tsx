    ...
    <header className="sticky top-0 z-50 w-full border-b border-slate-800/80 bg-slate-950/80 backdrop-blur-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-3 cursor-pointer shrink-0" onClick={() => onNavigate('/')}>
            <div className="relative flex items-center justify-center w-9 h-9 rounded-lg bg-[#0e1628] border border-slate-700/80 shrink-0">
            ...
            <div className="shrink-0">
              <div className="flex items-center space-x-2">
                <span className="text-lg sm:text-xl font-bold tracking-tight text-white font-mono whitespace-nowrap">STAGEGATE<span className="text-indigo-400">.OS</span></span>
                <span className="hidden sm:inline-flex px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wider bg-indigo-950/80 text-indigo-300 border border-indigo-700/50 rounded-full whitespace-nowrap shrink-0">
                  Autonomous Engine
                </span>
              </div>
              <p className="text-[10px] text-slate-400 hidden sm:block whitespace-nowrap">Deterministic Venture Platform</p>
            </div>
          </div>
